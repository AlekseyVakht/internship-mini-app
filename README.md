...
Ссылка на приложение в VK: https://vk.com/app51876629_52909208

## 🚀 Запуск мини приложения

Для работы приложения, необходимо склонировать его из репозитория

```sh
git clone git@github.com:AlekseyVakht/internship-mini-app.git
```
